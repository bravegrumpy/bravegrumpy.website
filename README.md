...
- I moved a lot of the experimentation with php and containers to its own branch.
- I also made the experimentation with docker and php saved in an archival branch.
- Because I made an archive branch, I am deleting all of the extra technical debt, keeping only the html, errant js pages.
- CSS stays.

**Goals**

- [ ] I want to use chat GPT to help me remove som eof the technical debt, and figure out how to add in a normal js framework, to make the UI more consistent.
